...
config :football_market, FootballMarketWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "LSvgDeGfMH1XBkSsiRklvecBkvdKUrYsrJ2r40RlRhGH99sGpdPBXB7cWjY1yG60",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:football_market, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:football_market, ~w(--watch)]}
  ]
