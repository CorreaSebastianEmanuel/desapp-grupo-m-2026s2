...
#
#     PHX_SERVER=true bin/football_market start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :football_market, FootballMarketWeb.Endpoint, server: true
end
  ...
  config :football_market, FootballMarketWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/football_market_web/router\.ex$"E,
        ~r"lib/football_market_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :football_market, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
